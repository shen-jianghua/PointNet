...
//{
//    //这边进行一个初始化的过程
//    const char* onnxfilename = "..\\weights\\mnist.onnx";
//    std::string engine_file = "..\\weights\\segmentation_model_Airplane_0.engine";
//    
//
...
//    PointNetONNX pointnet = PointNetONNX(onnxfilename, engine_file);
//    std::fstream engine_reader;
//    engine_reader.open(engine_file, std::ios::in);
//    if (engine_reader)
//    {
//        std::cout << "found engine plan" << std::endl;
//        pointnet.loadEngineFromFile();
//    }
//    else
//    {
//        //pointnet.onnxToTRTModel(trt_model_stream);
//        pointnet.onnxToTRTModel(onnxfilename, trt_model_stream);
//    }
//    pointnet.doInference(points, 2500);
//    return 0;
//}
